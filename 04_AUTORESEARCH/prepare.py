"""
One-time data preparation for zombie-autoresearch experiments.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Prepare data and tokenizer for zombie-autoresearch")
    parser.add_argument(
        "--dataset",
